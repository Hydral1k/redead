...
CreateConVar( "sv_redead_zombies_per_player_zombie", "0.5", { FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_SERVER_CAN_EXECUTE }, "Controls the amount of zombie NPCs that spawn per player zombie. (def 0.5)" )
